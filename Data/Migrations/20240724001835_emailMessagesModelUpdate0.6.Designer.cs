...
namespace HelpDeskWebSite.Data.Migrations
{
    ...
    [Migration("20240724001835_emailMessagesModelUpdate0.6")]
    partial class emailMessagesModelUpdate06
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HelpDeskWebSite.Models.Conversation", b =>
                {
            ...
            modelBuilder.Entity("HelpDeskWebSite.Models.Email", b =>
                {
            ...
            modelBuilder.Entity("HelpDeskWebSite.Models.User", b =>
                {
            ...
            modelBuilder.Entity("HelpDeskWebSite.Models.Conversation", b =>
                {
                    b.HasOne("HelpDeskWebSite.Models.User", "StartedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("HelpDeskWebSite.Models.Email", b =>
                {
                    b.HasOne("HelpDeskWebSite.Models.Conversation", "Conversation")
                        .WithMany("Emails")
                        .HasForeignKey("ConversationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HelpDeskWebSite.Models.User", "Recipient")
                        .WithMany("ReceivedEmails")
                        .HasForeignKey("RecipientId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("HelpDeskWebSite.Models.User", "Sender")
                        .WithMany("SentEmails")
